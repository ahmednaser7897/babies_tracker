class AppAssets {
  ...
  ///  icons
  static String request = "${iconsPath}request.png";
  ...
  static String feeding = "${imagesPath}feeding.png";
  static String sleeping = "${imagesPath}sleeping.png";
  static String vaccination = "${imagesPath}vaccination.png";
}
